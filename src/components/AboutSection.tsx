...
export const AboutSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (!isTouchDevice && portraitParallaxRef.current) {
        gsap.fromTo(
    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-20 md:py-24 lg:py-28">
        <div className="flex items-baseline justify-between gap-6">
          <span className="editorial-eyebrow" style={{ color: '#6F6860' }}>
            ABOUT
          </span>
          <span className="editorial-eyebrow" style={{ color: '#6F6860' }}>
            1977 — NOW
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12 lg:gap-16 xl:gap-20 items-stretch">
          <div className="md:col-span-5">
            ...
            >
              <div ref={portraitParallaxRef} className="will-change-transform">
                <img
          ...
          <div className="md:col-span-7 flex flex-col justify-between">
            ...
            >
              Babubhai
              <br />
              <span style={{ color: '#5A2028' }}>Thiba</span>
            </h2>
            ...
            >
              ...
              >
                Babubhai Thiba is a veteran film producer, celebrity manager and
                industry consultant with more than four decades of experience
              ...
              >
                Since beginning his career in Mumbai in 1977, he has worked
                across film, television and OTT, building long-standing
                professional relationships with artists, producers and
                businesses.
              </p>
              <p
                className="font-body leading-[1.75]"
              ...
              >
                His work spans production, celebrity management and industry
                consultation, with a focus on professional relationships,
            ...
            <div
              ref={factsRef}
              className="mt-8 md:mt-0 grid grid-cols-1 sm:grid-cols-3"
              style={{
            ...
            >
              {ABOUT_FACTS.map((fact, index) => (
                <div
                  key={fact.label}
                  className="py-4 sm:px-5 first:pl-0 last:pr-0 sm:border-l"
                  style={{
                    borderColor: index > 0 ? '#C8BFB2' : 'transparent',
                  }}
                >
                  <p
